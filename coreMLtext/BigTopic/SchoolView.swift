...
struct SchoolView: View {
    ...
    private let levels: [(name: String, icon: String, view: AnyView, words: [Vocabulary])] = [
        ("Classroom1", "book.fill", AnyView(HomeGame(levelData: BathroomData).navigationBarBackButtonHidden(true)), BathroomData.game_vocabulary),
        ("Classroom2", "pencil", AnyView(HomeGame(levelData: KitchenData).navigationBarBackButtonHidden(true)), KitchenData.game_vocabulary),
        ("Music", "music.note", AnyView(HomeGame(levelData: Living_roomData).navigationBarBackButtonHidden(true)), Living_roomData.game_vocabulary),
        ("Playground", "sportscourt.fill", AnyView(HomeGame(levelData: GarageData).navigationBarBackButtonHidden(true)), GarageData.game_vocabulary),
    ]
