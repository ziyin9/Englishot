...
struct SchoolView: View {
    ...
    private let levels: [(name: String, icon: String, view: AnyView, words: [Vocabulary])] = [
            ("Classroom1", "book.fill", AnyView(HomeGame(levelData: Classroom1Data).navigationBarBackButtonHidden(true)), Classroom1Data.game_vocabulary),
            ("Classroom2", "pencil", AnyView(HomeGame(levelData: Classroom2Data).navigationBarBackButtonHidden(true)), Classroom2Data.game_vocabulary),
            ("Music", "music.note", AnyView(HomeGame(levelData: MusicData).navigationBarBackButtonHidden(true)), MusicData.game_vocabulary),
            ("Playground", "sportscourt.fill", AnyView(HomeGame(levelData: PlaygroundData).navigationBarBackButtonHidden(true)), PlaygroundData.game_vocabulary),
            ("Sports", "sportscourt.fill", AnyView(HomeGame(levelData: SportsData).navigationBarBackButtonHidden(true)), SportsData.game_vocabulary),
        ]
