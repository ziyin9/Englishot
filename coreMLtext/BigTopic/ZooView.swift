...
struct ZooView: View {
    ...
    private let levels: [(name: String, icon: String, view: AnyView, words: [Vocabulary])] = [
            ("Mammals1", "hare.fill", AnyView(TGame(levelData: Mammals1Data, ML_model: "Zoo").navigationBarBackButtonHidden(true)), Mammals1Data.game_vocabulary),
            ("Mammals2", "tortoise.fill", AnyView(TGame(levelData: Mammals2Data, ML_model: "Zoo").navigationBarBackButtonHidden(true)), Mammals2Data.game_vocabulary),
            ("Mammals3", "dog.fill", AnyView(TGame(levelData: Mammals3Data, ML_model: "Zoo").navigationBarBackButtonHidden(true)), Mammals3Data.game_vocabulary),
            ("Marine Animals", "fish.fill", AnyView(TGame(levelData: Marine_AnimalsData, ML_model: "Zoo").navigationBarBackButtonHidden(true)), Marine_AnimalsData.game_vocabulary),
            ("Birds", "fish.fill", AnyView(TGame(levelData: BirdsData, ML_model: "Zoo").navigationBarBackButtonHidden(true)), BirdsData.game_vocabulary)
        ]
